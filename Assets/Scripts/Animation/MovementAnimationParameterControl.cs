...
public class MovementAnimationParameterControl : MonoBehaviour
{
    ...
    private void AnimatonEventPlayFootstepSound()
    {
        Debug.LogError("Play Sound");
    }

    void SetAnimationParameters(float xInput, float yInput, bool isWalking, bool isRunning, bool isIdle, bool isCarrying, ToolEffect toolEffect,
